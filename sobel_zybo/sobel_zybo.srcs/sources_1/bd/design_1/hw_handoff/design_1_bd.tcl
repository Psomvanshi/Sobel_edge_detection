...
proc create_root_design { parentCell } {
  ...
  set sobel_edge_detect_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:sobel_edge_detect:1.0 sobel_edge_detect_0 ]
  ...
  connect_bd_intf_net -intf_net sobel_edge_detect_0_stream_out [get_bd_intf_pins sobel_edge_detect_0/stream_out] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
  ...
  connect_bd_intf_net -intf_net v_vid_in_axi4s_0_video_out [get_bd_intf_pins sobel_edge_detect_0/stream_in] [get_bd_intf_pins v_vid_in_axi4s_0/video_out]
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins sobel_edge_detect_0/ap_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net one_dout [get_bd_ports hdmi_hpd] [get_bd_pins one/dout] [get_bd_pins sobel_edge_detect_0/ap_rst_n] [get_bd_pins sobel_edge_detect_0/ap_start]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins clk_wiz/reset] [get_bd_pins zero/dout]
